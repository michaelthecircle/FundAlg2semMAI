...
memory *border_descriptors_memory::get_memory() const {
    return memory::get_memory();
}

void *border_descriptors_memory::get_buddies(void *target_ptr) const {
    return memory::get_buddies(target_ptr);
}

bool border_descriptors_memory::is_free_block(void *target_ptr) const {
    return memory::is_free_block(target_ptr);
}
